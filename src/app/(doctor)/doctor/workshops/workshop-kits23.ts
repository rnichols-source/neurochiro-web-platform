export const KIT_2 = {
  id: 'kit-pediatric',
  title: 'Your Child\'s Nervous System',
  subtitle: 'Pediatric Workshop Kit',
  audience: 'Parents — moms groups, daycares, preschools',
  price: 49,
  format: '45-minute presentation',
  expectedResults: {
    attendees: '15-30 parents',
    signUpRate: '40-60%',
    showRate: '70-80%',
    caseAcceptance: '50-65%',
    exampleCalc:
      '25 attendees x 50% sign-up = 12-13 scans. 60% case acceptance = 7-8 new patient families. Average family value $3,000-$5,000 = $21,000-$40,000 in care plans from one workshop.',
  },
  sections: {
    preEvent: {
      title: 'Pre-Event Marketing & Outreach',
      items: [
        {
          title: 'Social Media Post — Awareness',
          type: 'social',
          content: `🧒 Did you know that 80% of your child's neurological development happens before age 5?

Most parents don't realize how much birth, falls, and screen time impact their child's nervous system — and it shows up as sleep issues, behavioral struggles, and missed milestones.

Join [DOCTOR NAME] at [PRACTICE NAME] on [DATE] for a FREE workshop:

"Your Child's Nervous System — What Every Parent Needs to Know"

📅 [DATE] at [TIME]
📍 [LOCATION]

This isn't about back pain. This is about giving your child the best possible foundation for development.

Spots are limited — comment "KIDS" or DM us to reserve your seat!

#PediatricHealth #NervousSystem #ChildDevelopment #[PRACTICE NAME]`,
        },
        {
          title: 'Printed Flyer — Daycare / Preschool',
          type: 'flyer',
...
• Chronic ear infections or illness?
...
Hosted by [DOCTOR NAME], [PRACTICE NAME]

[DATE] | [TIME]
[LOCATION]

RSVP: [PHONE] or visit [WEBSITE]
Space is limited — bring a friend!`,
        },
        {
          title: 'Email Invitation — Moms Group / Parent List',
          type: 'email',
          content: `Subject: What every parent needs to know about their child's nervous system

Hi [FIRST NAME],

I'm hosting a free workshop for parents and I'd love for you to be there.

It's called "Your Child's Nervous System — What Every Parent Needs to Know" and it's designed for parents who want to understand why their kids might be struggling with sleep, focus, behavior, or getting sick all the time.

Here's what we'll cover:
— Why 80% of neurological development happens before age 5
— How birth, falls, and screen time affect your child's wiring
— What a pediatric nervous system scan reveals (I'll show real examples)
— Gentle, drug-free options that are changing kids' lives

📅 [DATE] at [TIME]
📍 [LOCATION]

This is not your typical health talk. There's no pressure, no sales pitch — just information every parent deserves to have.

Click here to RSVP: [WEBSITE]
Or text us at [PHONE]
...
[PRACTICE NAME]`,
        ...
        {
          title: 'Text Message Invitation',
          type: 'text',
          content: `Hi [FIRST NAME]! Dr. [DOCTOR NAME] here from [PRACTICE NAME]. I'm hosting a free workshop for parents on [DATE] at [TIME] — "Your Child's Nervous System: What Every Parent Needs to Know." We'll cover how birth, falls, and screen time impact your child's development and what you can do about it. Would love to see you there! Reply YES to save your spot or call [PHONE].`,
        },
        {
          title: 'Countdown Post 1 — 5 Days Out',
          type: 'social',
          content: `5 DAYS until our free parent workshop! 🧠

"Your Child's Nervous System — What Every Parent Needs to Know"

Here's something that might surprise you: the most common interference to your child's nervous system starts at birth.

We're going to talk about what that means and what you can do about it on [DATE] at [TIME].

Comment "KIDS" to save your spot!`,
        },
        {
          title: 'Countdown Post 2 — 3 Days Out',
          type: 'social',
          content: `3 DAYS AWAY! 🎉

Quick question for parents: Has your child ever had any of these?
...
These are all connected to the nervous system — and most parents have no idea.

Join us [DATE] at [TIME] to learn more.

DM us or call [PHONE] to reserve your seat.`,
        },
        {
          title: 'Countdown Post 3 — Day Of',
          type: 'social',
          content: `TONIGHT! 🙌

Our FREE parent workshop is happening TODAY at [TIME].

"Your Child's Nervous System — What Every Parent Needs to Know"

📍 [LOCATION]

Walk-ins welcome, but spots are filling fast. See you there!`,
        },
        {
          title: 'Confirmation Text — Day Before',
          type: 'text',
          content: `Hi [FIRST NAME]! Just a reminder — our parent workshop "Your Child's Nervous System" is TOMORROW at [TIME] at [LOCATION]. We're excited to see you! Feel free to bring another parent who might benefit. See you there! — [PRACTICE NAME]`,
        },
        {
          title: 'RSVP Tracker Template',
          type: 'tracker',
          content: `RSVP TRACKING SHEET

Event: Your Child's Nervous System Workshop
...
- Phone
- Email
- Source (social / flyer / referral / text / email)
- RSVP Date
- Confirmed (Y/N)
- Attended (Y/N)
- Number of Children
- Ages of Children
- Signed Up for Scan (Y/N)
- Scan Scheduled Date
- Notes

Goal: 25+ RSVPs for 15-20 attendees`,
        },
      ],
    },
    presentation: {
...
• Your energy RIGHT NOW sets the tone. If you're pumped and grateful, your team catches that. If you're deflated, they check out. Be the leader. Even if only 8 families signed up — those are 8 children whose lives you're about to change. That MATTERS.`,
    ...
    materials: {
      ...
      items: [
        {
          title: 'Room Setup — Kid-Friendly Environment',
          type: 'setup',
          content: `ROOM SETUP CHECKLIST — PEDIATRIC WORKSHOP

Environment:
□ Bright, welcoming tablecloth on sign-in table
□ Small toy corner or coloring area if children attend
□ Coloring sheets and crayons on chairs (optional — great for parents who bring kids)
□ Sticker packs as door gift (one per child)
□ Background music: upbeat but calm (acoustic, lo-fi, or children's instrumental)
□ Projector or large TV for scan images
□ Good lighting — not clinical or harsh

Sign-In Table:
□ Sign-in sheet (see below)
□ Pens
□ Name tags (optional — "Hi, I'm [NAME], parent of [CHILD]")
□ Handouts stacked neatly
□ Business cards

Presentation:
□ Laptop with slides loaded and tested
□ Clicker / remote
□ Backup of slides on USB
□ Scan images preloaded (healthy vs. symptomatic)
□ Water for presenter

Team:
□ One team member at sign-in table greeting attendees
□ One team member circulating after the talk
□ Both team members trained on follow-up language`,
        },
        {
          title: 'Sign-Up Sheet — Pediatric',
          type: 'form',
          content: `[PRACTICE NAME] — Family Nervous System Scan

"Thank you for attending tonight's workshop! If you'd like to bring your child (or family) in for a complimentary nervous system scan, fill out the info below and we'll reach out to schedule a convenient time."

Parent Name: _________________________
Phone: _________________________
Email: _________________________
Child Name(s): _________________________
Child Age(s): _________________________
Main Concern(s): _________________________
Preferred Day/Time: _________________________
How did you hear about this event? _________________________`,
        },
        {
          title: 'Handout: "5 Signs Your Child\'s Nervous System Needs Attention"',
          type: 'handout',
          content: `5 SIGNS YOUR CHILD'S NERVOUS SYSTEM NEEDS ATTENTION

[PRACTICE NAME] | [DOCTOR NAME] | [PHONE] | [WEBSITE]

1. SLEEP STRUGGLES
If your child has trouble falling asleep, staying asleep, or waking up rested, it may be a sign their nervous system is stuck in "go" mode. A healthy nervous system transitions smoothly between alert and rest states. If your child's can't — sleep is the first thing to suffer.

2. FREQUENT ILLNESS OR EAR INFECTIONS
Recurring colds, ear infections, or chronic congestion often point to a nervous system that isn't supporting proper immune function and drainage. If antibiotics keep coming back into the picture, it's worth looking deeper.

3. BEHAVIORAL CHALLENGES OR MELTDOWNS
Tantrums are normal. But prolonged, intense, daily meltdowns — especially ones that seem disproportionate to the trigger — may indicate a nervous system stuck in fight-or-flight. When a child's stress response is always on, emotional regulation becomes nearly impossible.

4. DIFFICULTY FOCUSING OR SITTING STILL
Before reaching for a diagnosis, consider the nervous system. A child whose brain-body connection is compromised will struggle to focus, follow directions, and stay on task — not because they won't, but because their nervous system won't let them.

5. DEVELOPMENTAL DELAYS OR MISSED MILESTONES
Crawling late, walking late, speech delays — these can all be connected to nervous system interference. The brain sends the signal. If the pathway is blocked or disrupted, the milestone gets delayed.

WHAT YOU CAN DO:
Schedule a complimentary nervous system scan for your child. It's painless, takes about 15 minutes, and gives you a clear picture of how your child's nervous system is functioning.

Call us: [PHONE]
Visit: [WEBSITE]
[PRACTICE NAME] — Helping families thrive, from the inside out.`,
        },
      ],
    },
    postEvent: {
      ...
      items: [
        {
          title: 'Same-Night Text — Within 1 Hour of Event',
          type: 'text',
          content: `Hi [FIRST NAME]! Thank you so much for coming to our parent workshop tonight! It was great meeting you. If you'd like to bring [CHILD NAME] in for a nervous system scan, we have a few spots open this week. Want me to save one for you? Just reply with a day that works! — [DOCTOR NAME], [PRACTICE NAME]`,
        },
        {
          title: 'Day-After Email',
          type: 'email',
          content: `Subject: Great seeing you last night — here's your next step for [CHILD NAME]

Hi [FIRST NAME],

Thank you for coming to our workshop last night. I could tell how much you care about [CHILD NAME]'s health, and I'm glad you took the time to learn about how the nervous system plays a role in your child's development.

Here's a quick recap of what we covered:
• 80% of neurological development happens before age 5
• Birth, falls, and screen time can create interference in the nervous system
• That interference often shows up as sleep issues, behavioral challenges, focus problems, and frequent illness
• A simple, painless nervous system scan can reveal what's happening under the surface

If you'd like to bring [CHILD NAME] in for a complimentary scan, we'd love to see your family. It takes about 15 minutes, and there's absolutely no obligation.

Click here to book: [WEBSITE]
Or call us: [PHONE]

Looking forward to meeting [CHILD NAME]!
...
[PRACTICE NAME]`,
        ...
        {
          title: 'Day 3 Follow-Up Text',
          type: 'text',
          content: `Hi [FIRST NAME]! Quick follow-up from our parent workshop — have you had a chance to think about bringing [CHILD NAME] in for a scan? We have openings this week and would love to see your family. Just reply or call [PHONE] to book! — [PRACTICE NAME]`,
        },
        {
          title: 'Day 7 Follow-Up Email — Final Touch',
          type: 'email',
          content: `Subject: One more thing about [CHILD NAME]'s nervous system

Hi [FIRST NAME],

I wanted to follow up one more time from our parent workshop last week.

I know life with kids is busy — believe me, I get it. But if anything from that evening stuck with you — if you recognized your child in any of the stories or signs we talked about — I'd encourage you to take the next step.

A nervous system scan takes 15 minutes. It's painless. It's complimentary. And it gives you information you simply can't get anywhere else.

No pressure. Just a parent looking out for their child's health — and a doctor who wants to help.
...
[PRACTICE NAME]`,
    ...
    tracking: {
      title: 'Conversion Tracking — Pediatric Workshop',
      content: `PEDIATRIC WORKSHOP — CONVERSION TRACKER
...
2. SIGN-UPS
   - Total sign-ups at event: ____
   - Sign-up rate: ____ %
   - Children signed up: ____
   - Family scans requested: ____

3. APPOINTMENTS
   - Scans scheduled: ____
   - Scans completed: ____
   - No-shows: ____
   - Show rate: ____ %

4. CONVERSIONS
   - Care plans presented: ____
   - Care plans accepted: ____
   - Case acceptance rate: ____ %
   - Total revenue from workshop: $____
   - Revenue per attendee: $____

5. FAMILY MULTIPLIER
   - Parents who also started care: ____
   - Siblings added: ____
   - Total family members from workshop: ____
   - Family revenue multiplier: ____x

6. FOLLOW-UP EFFECTIVENESS
   - Same-night text response rate: ____ %
   - Day-after email open rate: ____ %
   - Day 3 text response rate: ____ %
   - Day 7 email open rate: ____ %
   - Bookings from follow-up (not at event): ____
...
export const KIT_3 = {
  id: 'kit-corporate',
  title: 'Lunch & Learn: Peak Performance',
  subtitle: 'Corporate / Workplace Workshop Kit',
  audience: 'Offices, businesses, gyms, CrossFit',
  price: 49,
  format: '30-minute presentation (lunch break)',
  expectedResults: {
    attendees: '10-25 employees',
    signUpRate: '30-50%',
    showRate: '80-90% (they are already at work)',
    caseAcceptance: '40-55%',
    exampleCalc:
      '20 attendees x 40% sign-up = 8 scans. 50% case acceptance = 4 new patients. Average case value $2,500-$4,000 = $10,000-$16,000 per event. Run one per month at different businesses = $120,000-$192,000/year pipeline.',
  },
  sections: {
    preEvent: {
      title: 'Pre-Event Marketing & Outreach',
      items: [
        {
          title: 'Email to Business Owner / HR — Pitching the Event',
          type: 'email',
          content: `Subject: Free wellness lunch & learn for your team — no cost, no catch

Hi [FIRST NAME],

My name is [DOCTOR NAME], and I run [PRACTICE NAME] here in [CITY]. I'm reaching out because I'd love to offer your team a complimentary wellness presentation during a lunch break.

It's called "Peak Performance: How Your Nervous System Controls Your Productivity" and it's a 30-minute talk designed specifically for professionals.

Here's what your team will learn:
— Why brain fog, afternoon crashes, and chronic pain are connected to the nervous system
— How sitting and screen time are silently degrading performance
— 3 simple strategies they can implement immediately to feel and perform better

There's no cost to you or your employees. I bring the content — you just provide the conference room. I can even coordinate with your schedule to minimize disruption.

Companies like [EXAMPLE COMPANY or "businesses across our area"] have hosted these and the feedback has been overwhelmingly positive.

Would you be open to a quick call to see if this would be a good fit for your team? I'm happy to work around your schedule.
...
[PHONE] | [WEBSITE]`,
        ...
        {
          title: 'Social Media Post — Promoting to Your Audience',
          type: 'social',
          content: `If you sit at a desk for 8+ hours a day, this is for you.

The average American spends 7.5 hours sitting. Your body was designed to move. And that gap is destroying your energy, your focus, and your performance.

[DOCTOR NAME] is bringing a FREE "Lunch & Learn" to local businesses — a 30-minute presentation on how your nervous system controls everything from your productivity to your pain.

Know a business owner or HR manager who'd want to bring this to their team? Tag them below or DM us!

#PeakPerformance #WorkplaceWellness #NervousSystemHealth #[PRACTICE NAME]`,
        },
        {
          title: 'Breakroom Flyer — For the Host Business',
          type: 'flyer',
          content: `LUNCH & LEARN
Peak Performance: How Your Nervous System Controls Your Productivity

FREE 30-Minute Wellness Talk

Do you experience:
• Brain fog by 2 PM?
• Neck or back pain you've just "accepted"?
• Afternoon energy crashes?
• Headaches or tension from screens?
• Trouble sleeping even though you're exhausted?

It's not normal. And it's not just stress.

Join [DOCTOR NAME] from [PRACTICE NAME] for a quick, eye-opening presentation on how your nervous system is running the show — and what you can do about it.

[DATE] | [TIME]
[LOCATION / CONFERENCE ROOM]

Lunch will be provided. No sign-up required — just show up!`,
        },
        {
          title: 'Text to Existing Patients at Target Companies',
          type: 'text',
          content: `Hey [FIRST NAME]! Quick heads up — [DOCTOR NAME] is doing a free wellness talk at [COMPANY NAME] on [DATE] during lunch. If you work there, come check it out! And if you know anyone in the office who could benefit from what we do, this is a great way to introduce them. Let me know if you have any questions! — [PRACTICE NAME]`,
        },
      ],
    },
    presentation: {
...
- Do NOT forget the family upsell — it can double your conversion from one event`,
    ...
    materials: {
      ...
      items: [
        {
          title: 'Room Setup — Conference Room',
          type: 'setup',
          content: `ROOM SETUP CHECKLIST — CORPORATE LUNCH & LEARN

Environment:
□ Conference room or break room with seating for expected attendees
□ Projector, TV, or large monitor (confirm with host in advance)
□ HDMI cable or adapter (bring your own backup)
□ Professional appearance — business casual minimum
□ No banners or marketing materials on the walls — you're a guest

Setup:
□ Arrive 15 minutes early
□ Laptop with slides loaded and tested on their AV system
□ Clicker / remote
□ Sign-up sheets placed on a side table (not blocking the door)
□ Handouts at each seat
□ Business cards in a small stack near sign-up sheet
□ Water for presenter

Team:
□ One team member maximum (keep it low-key)
□ Team member manages sign-up sheet, not the doctor
□ Team member dressed professionally

Important:
□ Do NOT rearrange their furniture
□ Do NOT put up posters or banners
□ Do NOT hand out anything aggressively
□ Do NOT overstay — be out within 10 minutes of finishing
□ Thank the host personally before leaving`,
        },
        {
          title: 'Sign-Up Sheet — Corporate',
          type: 'form',
          content: `[PRACTICE NAME] — Complimentary Nervous System Scan

"Interested in seeing how your nervous system is performing? Fill out the info below and our team will reach out to schedule a convenient time."

Name: _________________________
Email: _________________________
Phone: _________________________
Best Time to Reach You: _________________________
Main Concern (optional): _________________________`,
        },
        {
          title: 'Handout: "The Executive\'s Guide to Nervous System Health"',
          type: 'handout',
          content: `THE EXECUTIVE'S GUIDE TO NERVOUS SYSTEM HEALTH
3 Strategies for Desk Workers

[PRACTICE NAME] | [DOCTOR NAME] | [PHONE] | [WEBSITE]

YOUR NERVOUS SYSTEM IS YOUR OPERATING SYSTEM
It controls your energy, focus, pain response, sleep quality, and stress tolerance. When it's compromised, everything suffers — including your performance.

STRATEGY 1: THE 30/60 RULE
Every 30 minutes, stand and move for 60 seconds. Walk to the water cooler. Do 10 squats. Stretch. Whatever you want — just break the sitting cycle. This interrupts the compression pattern on your spine and gives your nervous system a micro-reset.

Why it works: Prolonged sitting compresses the lumbar spine and shifts the cervical curve forward. Both create nervous system interference. Breaking the pattern every 30 minutes prevents the compression from accumulating.

STRATEGY 2: CHIN TUCKS — THE DESK WORKER'S BEST FRIEND
Sit or stand tall. Pull your chin straight back (like making a double chin). Hold for 5 seconds. Release. Repeat 10 times, 3 times per day.

Why it works: Forward head posture adds up to 42 pounds of extra pressure on your cervical spine. Chin tucks retrain the deep cervical flexors and restore proper alignment, reducing nerve interference in the area that controls headaches, focus, and energy.

STRATEGY 3: BOX BREATHING — REBOOT YOUR STRESS RESPONSE
At the end of your workday (or anytime you feel overwhelmed):
...
Why it works: Box breathing activates your parasympathetic nervous system — the recovery and repair mode. It manually overrides the fight-or-flight state that accumulates throughout the day. Navy SEALs use this technique. It's that effective.

WANT TO SEE HOW YOUR NERVOUS SYSTEM IS PERFORMING?
Schedule a complimentary scan — 15 minutes, no obligation, objective data about your neurological function.
...
[PRACTICE NAME]`,
    ...
    postEvent: {
      ...
      items: [
        {
          title: 'Same-Day Follow-Up Email — Professional Tone',
          type: 'email',
          content: `Subject: Great meeting you at [COMPANY NAME] — here's your next step

Hi [FIRST NAME],

Thanks for taking time out of your lunch today to learn about nervous system health. I hope you found it valuable.

As a quick recap, here are the three strategies I shared:
1. The 30/60 Rule — stand and move for 60 seconds every 30 minutes
2. Chin Tucks — 10 reps, 3 times per day to counteract forward head posture
3. Box Breathing — 5 minutes of 4-second cycles to reset your stress response

If you signed up for a complimentary nervous system scan, my team will be reaching out shortly to find a time that works with your schedule. The scan takes about 15 minutes and gives you an objective picture of how your nervous system is functioning.

If you didn't sign up but you're curious, just reply to this email or call us at [PHONE]. No pressure — just data.
...
[PHONE] | [WEBSITE]`,
        ...
        {
          title: 'Same-Day Text to Sign-Ups',
          type: 'text',
          content: `Hi [FIRST NAME], it's [DOCTOR NAME] from [PRACTICE NAME]. Great meeting you at [COMPANY NAME] today! I'd love to get your nervous system scan scheduled. Do you have any availability this week? We have openings [DAY] and [DAY]. Just reply with what works best!`,
        },
        {
          title: 'Day 3 Follow-Up Text — Non-Responders',
          type: 'text',
          content: `Hey [FIRST NAME]! Following up from the lunch & learn at [COMPANY NAME]. Still have a complimentary scan reserved for you — just need to find a time. Any openings this week? Takes about 15 min. — [DOCTOR NAME], [PRACTICE NAME] [PHONE]`,
        },
        {
          title: 'Day 5 Final Follow-Up Email',
          type: 'email',
          content: `Subject: Your complimentary nervous system scan — still available

Hi [FIRST NAME],

Just a quick follow-up from the wellness presentation at [COMPANY NAME] last week.

Your complimentary nervous system scan is still available. It's a 15-minute, no-obligation assessment that shows you exactly how your nervous system is performing — using objective data, not guesswork.

If you're dealing with any of the following, the scan is especially worth doing:
...
No pressure. Just information that can help you perform at your best.
...
[PRACTICE NAME]`,
    ...
    tracking: {
      title: 'Conversion Tracking — Corporate Lunch & Learn',
      content: `CORPORATE LUNCH & LEARN — CONVERSION TRACKER

Event: Peak Performance Lunch & Learn
Date: [DATE]
Company: [COMPANY NAME]
Location: [LOCATION]
Presenter: [DOCTOR NAME]
Host Contact: ____________________

METRICS TO TRACK:

1. ATTENDANCE
   - Estimated employees invited: ____
   - Total attended: ____
...
4. CONVERSIONS
   ...
   - Care plans accepted: ____
   - Case acceptance rate: ____ %
   - Total revenue from event: $____
   - Revenue per attendee: $____
   - Cost of event (time + materials): $____
   - ROI: ____x

5. FOLLOW-UP EFFECTIVENESS
   - Same-day email open rate: ____ %
   - Same-day text response rate: ____ %
   - Day 3 text response rate: ____ %
   - Day 5 email open rate: ____ %
   - Bookings from follow-up (not at event): ____

6. RELATIONSHIP METRICS
   - Host satisfaction (1-10): ____
   - Invited back (Y/N): ____
   - Referrals to other businesses: ____
   - Repeat event scheduled (Y/N): ____
   - Date of next event: ____

7. PIPELINE VALUE
   - Total companies contacted this month: ____
   - Events booked: ____
   - Events completed: ____
   - Total patients from corporate events (running): ____
   - Total revenue from corporate events (running): $____
