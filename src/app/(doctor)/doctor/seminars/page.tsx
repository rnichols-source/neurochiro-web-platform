      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex items-center gap-4 relative overflow-hidden group">
            ...
            <div>
               ...
               <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-[10px] font-bold text-green-500">+{analytics?.totalAttendees || 0} Points Added</span>
               </div>
            </div>
         </div>
         <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex items-center gap-4 group">
            ...
            <div>
               ...
               <div className="flex items-baseline gap-2">
                  <p className="text-2xl font-black text-neuro-navy">${analytics?.grossRevenue?.toLocaleString() || '0'}</p>
                  <span className="text-[10px] font-bold text-neuro-orange">Real-time Sync</span>
               </div>
            </div>
         </div>
         <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex items-center gap-4 group">
           ...
           {mySeminars.length === 0 ? (
             <div className="bg-white rounded-[3rem] border-2 border-dashed border-gray-100 p-20 text-center space-y-6">
                ...
                <div className="max-w-xs mx-auto">
                   <h3 className="text-xl font-black text-neuro-navy">No Active Seminars</h3>
                   <p className="text-gray-500 text-sm mt-2">Start sharing your expertise and generating revenue by hosting your first event.</p>
                </div>
                <Link 
                  href="/host-a-seminar"
             ...
             <div key={i} className="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm group hover:shadow-xl transition-all relative overflow-hidden">
                {sem.is_boosted && (
                  <div className="absolute top-0 right-0 bg-neuro-orange text-white text-[9px] font-black uppercase tracking-widest px-4 py-1.5 rounded-bl-xl shadow-lg flex items-center gap-1.5 z-10">
                    <Sparkles className="w-3 h-3" /> Campaign Active
                  </div>
                )}
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
                   <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-500">
                         <span className="flex items-center gap-1"><MapPin className="w-3.5 h-3.5" /> {sem.city}, {sem.country}</span>
                         <div className="flex items-center gap-3">
                            <div className="flex items-center gap-1 px-2 py-0.5 bg-orange-50 text-neuro-orange rounded-full border border-orange-100">
                               ...
                               <span className="text-[8px] font-black uppercase">{sem.page_views} Total Views</span>
                            </div>
                            {sem.is_boosted && (
                              <div className="flex items-center gap-1 px-2 py-0.5 bg-blue-50 text-blue-600 rounded-full border border-blue-100">
                                 <TrendingUp className="w-2.5 h-2.5" />
                                 <span className="text-[8px] font-black uppercase">Visibility Boosted</span>
                              </div>
                            )}
                         </div>
                      </div>
                      {!sem.is_boosted && sem.is_approved && (
                        <div className="mt-4 p-3 bg-neuro-orange/5 rounded-xl border border-neuro-orange/10 inline-flex items-center gap-2 cursor-pointer hover:bg-neuro-orange/10 transition-colors" onClick={() => setIsCampaignOpen(sem)}>
                           <TrendingUp className="w-3 h-3 text-neuro-orange" />
                           <p className="text-[9px] font-black text-neuro-orange uppercase tracking-tight underline decoration-neuro-orange/30 underline-offset-2">Trending in your region. Boost now to secure sell-out.</p>
                        </div>
                      )}
                   </div>
