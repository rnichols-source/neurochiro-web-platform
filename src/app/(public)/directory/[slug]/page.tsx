            ...
            <div className="w-full lg:w-1/3 lg:sticky lg:top-32">
              ...
              >
                <div className="relative mb-14 group">
                  ...
                  <div className="w-56 h-56 rounded-[3rem] bg-neuro-navy border-4 border-neuro-orange/30 mx-auto flex items-center justify-center text-neuro-orange font-heading font-black text-7xl relative z-10 shadow-2xl shadow-black/40 overflow-hidden">
                    {doctor.photo_url ? (
                      <img 
                ...
                <div className="flex gap-4 mt-10">
                  <Link 
                    ...
                    target="_blank"
                    aria-label={`Follow Dr. ${doctor.last_name} on Instagram`}
                  ...
                  <Link 
                    ...
                    target="_blank"
                    aria-label={`Follow Dr. ${doctor.last_name} on Facebook`}
                    className="flex-1 py-5 bg-white/5 rounded-3xl hover:bg-white/10 transition-all flex items-center justify-center gap-2 border border-white/10 hover:border-white/30 hover:scale-[1.02] active:scale-95 group"
                  >
