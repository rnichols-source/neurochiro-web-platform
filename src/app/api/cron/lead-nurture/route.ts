    ...
    case 4:
      return {
        ...
        body: `
          ...
          <p style="margin: 20px 0;">
            <a href="https://neurochiro.co/get-started" style="color: #D66829; font-weight: bold;">Create your profile here</a>
          </p>
    ...
    case 1:
      return {
        ...
        body: `
          ...
          <p style="margin: 24px 0;">
            <a href="https://neurochiro.co/get-started" style="display: inline-block; background: #D66829; color: white; padding: 14px 28px; border-radius: 12px; font-weight: 900; text-decoration: none;">Create Account</a>
          </p>
          <p style="margin-top: 30px;"><strong>Dr. Raymond Nichols</strong><br>Founder, NeuroChiro</p>
        `,
      };
    ...
    case 3:
      return {
        ...
        body: `
          ...
          <p style="margin: 24px 0;">
            <a href="https://neurochiro.co/get-started" style="display: inline-block; background: #D66829; color: white; padding: 14px 28px; border-radius: 12px; font-weight: 900; text-decoration: none;">Join Now — 2 Minutes</a>
          </p>
          <p style="margin-top: 30px;"><strong>Dr. Raymond Nichols</strong><br>Founder, NeuroChiro</p>
        `,
      };
    case 4:
      return {
        ...
        body: `
          ...
          <p style="margin: 20px 0;">
            <a href="https://neurochiro.co/get-started" style="color: #D66829; font-weight: bold;">Create your account here</a>
          </p>
