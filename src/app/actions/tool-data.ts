...
/**
 * Shared tool data persistence for doctor and student portals.
 * Stores tool state in Supabase for cross-device sync.
 * Uses doctor_tool_data table (works for all roles via RLS).
 */
