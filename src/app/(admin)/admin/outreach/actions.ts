...
export async function getDMScripts(prospect_type: ProspectType = 'doctor') {
  ...
  return [
    ...
    },
    {
      ...
      category: 'follow_up',
      description: 'Last touch — create curiosity with views',
      template: `Last one from me {name} —\n\nJust wanted to let you know your profile at {profile_link} has been getting some views.\n\nFigured you'd want to know.\n\nClaim it whenever the timing feels right. It's not going anywhere.`,
    },
    {
      ...
      template: `That's awesome — glad it caught your eye!\n\nHere's all you need to do:\n\n1. Go to {profile_link}\n2. Click "Claim This Profile"\n3. Create a quick account\n4. Add your photo and bio\n\nThat's it. Takes about 2 minutes.\n\nYour free listing is live right away. If you want the verified badge, full profile, and patient messaging — that's our Pro plan at $99/mo. Most docs say it pays for itself with the first new patient.\n\nLet me know if you need help with anything 🤙`,
    },
    {
      id: 'signed_up',
    ...
    },
    {
      ...
      template: `I hear you — that's exactly why I already built it for you.\n\nYour profile is live right now:\n{profile_link}\n\nAll you'd need to do is click "Claim," add your photo, and you're done.\n\nLiterally 2 minutes between patients. After that, it works for you 24/7 without you touching it.\n\nNo meetings, no onboarding, no setup calls. Just claim and go.`,
    },
    {
      id: 'objection_why',
    ...
    {
      id: 'ig_comment',
      name: 'Instagram Comment (Post)',
      category: 'ig_comment',
      description: 'Drop this on one of their recent posts to get noticed',
      template: `This is exactly why nervous system chiropractic is the future. Love what you're doing at {clinic_name} 🔥 Just sent you a DM btw — built something I think you'll want to see 👀`,
    },
    {
      id: 'ig_comment_adjustment',
      name: 'IG Comment (Adjustment Video)',
      category: 'ig_comment',
      description: 'For posts showing adjustments or patient care',
      template: `The precision here is next level 🙌 This is what real nervous system work looks like. Dropped you a DM — think you'd be a great fit for something we're building.`,
    },
    {
      id: 'ig_comment_education',
      name: 'IG Comment (Educational Post)',
      category: 'ig_comment',
      description: 'For posts educating patients about chiropractic',
      template: `More docs need to be putting out content like this. Your patients are lucky 💯 Check your DMs when you get a sec — sent you something.`,
    },
    {
      id: 'ig_comment_generic',
      name: 'IG Comment (Generic)',
      category: 'ig_comment',
      description: 'Works on any post — short and natural',
      template: `Love this 🔥 Sent you a DM!`,
    },
    {
    ...
    {
      id: 'email_warm_intro',
      name: 'Email: Warm Intro',
      category: 'email',
      description: 'When you have a connection or referral',
      template: `Subject: {name} — thought you should see this\n\nHey {name},\n\nI came across {clinic_name} while building out the NeuroChiro network in {state} and I was genuinely impressed.\n\nNeuroChiro is the directory for nervous system chiropractors. I built a profile for you — it's live here:\n\n{profile_link}\n\nWe have doctors across the country listed and patients are using it daily to find nervous system chiros.\n\nI think your practice would be a great addition. Claiming your profile takes about 2 minutes.\n\nWould love to have you in the network.\n\nDr. Raymond Nichols\nFounder, NeuroChiro\nneurochiro.co`,
    },
    {
      id: 'email_phone_follow_up',
      name: 'Email: After Phone Call',
      category: 'email',
      description: 'Send after speaking with them',
      template: `Subject: Here's the link we talked about\n\nHey {name},\n\nGreat talking with you!\n\nHere's your NeuroChiro profile:\n{profile_link}\n\nJust click "Claim This Profile," add your photo and bio, and you're set. Takes about 2 minutes.\n\nIf you need anything at all, just reply here. I'm around.\n\nLooking forward to having {clinic_name} in the network.\n\nDr. Raymond Nichols\nFounder, NeuroChiro`,
    },
  ];
}
