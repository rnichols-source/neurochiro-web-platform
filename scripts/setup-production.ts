...
const checks: Omit<EnvCheck, 'isSet'>[] = [
  ...
  },
  {
    ...
    required: true,
    description: 'Stripe Price ID for the Starter plan ($49/month)',
    whereToGet: 'Stripe Dashboard > Product catalog > NeuroChiro Starter > Price ID (starts with price_)',
  },
  {
    name: 'STRIPE_GROWTH_PRICE_ID',
    required: true,
    description: 'Stripe Price ID for the Growth plan ($99/month)',
    whereToGet: 'Stripe Dashboard > Product catalog > NeuroChiro Growth > Price ID (starts with price_)',
  },
  {
    name: 'STRIPE_PRO_PRICE_ID',
    required: true,
    description: 'Stripe Price ID for the Pro plan ($199/month)',
    whereToGet: 'Stripe Dashboard > Product catalog > NeuroChiro Pro > Price ID (starts with price_)',
  },
  {
